namespace Application.Constants {
    public const string APP_NAME = "Snaptastic";
    public const string EXEC_NAME = "snap-tastic";
    public const string DESKTOP_NAME = "com.github.bartzaalberg.snap-tastic.desktop";
